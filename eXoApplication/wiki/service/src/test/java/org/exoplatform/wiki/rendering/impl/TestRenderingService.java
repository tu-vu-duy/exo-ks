...
public class TestRenderingService extends AbstractRenderingTestCase {
  ...
  public void testRenderCreatePageLink() throws Exception {
    ...
    String expectedHtml = "<p><span class=\"wikicreatelink\"><a href=\"http://loclahost:8080/portal/classic/wiki/WikiHome?action=AddPage&amp;pageTitle=NonExistedWikiPage-001#AddPageL\">NonExistedWikiPage-001</a></span></p>";
